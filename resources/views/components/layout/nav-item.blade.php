<li class="list-none group relative">
    <a href="{{ $href }}"
        @class([
            ...
            'font-semibold xl:font-normal' => ! $preventUnderline,
    ...
    @if ($slot->isNotEmpty())
        <div class="xl:hidden xl:group-hover:block xl:absolute text-base xl:font-semibold normal-case z-10">
            <ul class="left-0 mt-2.5 w-auto xl:rounded bg-white xl:shadow z-10 mx-auto px-5 py-2.5 grid gap-y-4">
                {{ $slot }}
            </ul>
        </div>
    @endif
