            ...
            <li>
                <div style="opacity: 1; transform: none;">
                    <div class="group relative overflow-hidden bg-neutral-100">
                        <img alt="" loading="lazy" width="1800" height="1800" decoding="async" data-nimg="1" class="h-96 w-full object-cover grayscale motion-safe:group-hover:grayscale-0 transition duration-500 motion-safe:group-hover:scale-105" src="{{ asset($person->image) }}" style="color: transparent;">
